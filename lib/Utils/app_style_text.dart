...
class AppStyleText {
  ...
  static const inputFiledSecondaryText = TextStyle(
    fontSize: 15,
    fontWeight: RFontWeight.LIGHT,
    color: kMainColor,
    height: 1.5,
  ...
  /*------------ INPUT FILED ------------*/
  static const inputFiledDropDownText = TextStyle(
    fontSize: 15,
    fontWeight: RFontWeight.LIGHT,
    color: kMainTextColor,
    height: 1.5,
  );
  static const inputFiledPrimaryHint = TextStyle(
      fontSize: 15, fontWeight: RFontWeight.LIGHT, color: kHintColor);
}

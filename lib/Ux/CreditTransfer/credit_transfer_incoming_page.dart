...
class CreditTransferIncomingPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return CreditTransferIncomingBody();
  }
}

class CreditTransferIncomingBody extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _CreditTransferIncomingBodyState();
}

class _CreditTransferIncomingBodyState
    extends BasePageState<CreditTransferIncomingBody, ViewModelCreditTransfer> {
  ...
  apiCall() {
    viewModel.requestCreditIncoming("$fromDate", "$toDate");
  }

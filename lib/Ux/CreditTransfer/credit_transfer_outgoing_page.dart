...
class CreditTransferOutgoingPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return CreditTransferOutgoingBody();
  }
}

class CreditTransferOutgoingBody extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _CreditTransferOutgoingBodyState();
}

class _CreditTransferOutgoingBodyState
    extends BasePageState<CreditTransferOutgoingBody, ViewModelCreditTransfer> {
  ...
  apiCall() {
    viewModel.requestCreditOutgoing(mSelectedUser.id, "$fromDate", "$toDate");
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: kColor11,
                  border: Border.all(width: .5, color: kMainTextColor),
                ),
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.start,
                  children: [
                    Text(
                      "${locale.totalOutgoing}",
                      style: TextStyle(
                          color: kMainColor,
